...
import {
  FaJsSquare, FaPython, FaJava, FaPhp, FaHtml5, FaCss3Alt, FaDatabase, FaMicrosoft, FaNetworkWired, FaCode, FaTools
} from "react-icons/fa";
          ...
          <div className="skill-card p-3">
            ...
            <div className="d-flex flex-wrap gap-2 mt-3">
              {cat.skills.map((skill, i) => (
                <span key={i} className="badge skill-badge d-flex align-items-center gap-1" style={{ fontSize: 15 }}>
